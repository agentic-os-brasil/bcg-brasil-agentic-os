...
authority-seed and native-store gates are approved, the update check command
persists one exact signed plan and the confirm step starts the stable bootstrapper
