...
- Refs: bundles/base/skills/maestro-onboarding/SKILL.md; installers/zip/user-template/.claude/hooks/first-run-scaffold.sh; PR #363 walter refine 2026-08-13
- Supersedes: none (refines PCOO)
