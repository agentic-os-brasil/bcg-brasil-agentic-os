...
| 🛡️ Versioned workspace migration | Immutable plans, bounded managed-file snapshots, governed hook/skill reprojection and rollback are implemented locally. Post-bootstrap execution remains unavailable until the stable bootstrapper supplies authenticated core activation and an explicit workspace target. |
