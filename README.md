...
| ✅ Local ingestion | Provider-neutral contract, Docling-first selector and fail-closed ingest contract; the optional fallback adapter is descoped pending an opensource, ZIP-embeddable replacement. Conversion remains unavailable until an approved managed runtime pack is verified. |
