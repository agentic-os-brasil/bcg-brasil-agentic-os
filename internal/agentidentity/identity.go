...
func InitialInterview() Interview {
	return Interview{
		...
		Steps: []InterviewStep{
			...
			{Field: "capability_tracks", Question: "Quais trilhas profissionais você quer ativar no Canary?", Explanation: "A seleção é opcional, explícita e independente do interaction-profile. Uma trilha indisponível não é simulada."},
		...
		CapabilityTracks: []CapabilityTrack{
			...
			{ID: "data-science", DisplayName: "Ciência de dados", Description: "Avaliação de ciência de dados dependente de um runtime de dados qualificado.", Availability: "unavailable"},
			{ID: "data-engineering", DisplayName: "Engenharia de dados", Description: "Qualidade e reprodutibilidade de pipelines dependentes de um runtime de dados qualificado.", Availability: "unavailable"},
		},
	}
}
