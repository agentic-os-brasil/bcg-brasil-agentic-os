...
`salt` is a fresh 32-byte random value generated by the daily pass at the
start of the day's export and never reused across days or across
workspaces. It is stored as `sha256:<hex>` for shape uniformity with other
