...
Resolva a skill canônica [`interaction-profile`](../interaction-profile/SKILL.md) antes de conduzir a entrevista, para aplicar o estilo de comunicação e disclosure do owner.
