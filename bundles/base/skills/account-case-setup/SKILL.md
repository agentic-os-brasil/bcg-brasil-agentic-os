...
5. For a Case Agent, use `$case-agent-setup` to create the reviewed project brief, first plan and its next action. Keep the Case Agent within its workspace and make promotion back to the account periodic and deliberate.
