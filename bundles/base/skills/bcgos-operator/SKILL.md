...
4. **Responda com resultado + próximo passo** — nunca exponha jargão CLI sem necessidade.
...
- Não rode `bcgos` diretamente — o CLI não está disponível no runtime do ZIP; todas as
  operações são realizadas pelos skills listados acima.
