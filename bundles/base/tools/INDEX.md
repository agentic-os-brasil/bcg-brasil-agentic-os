...
Duas linhas saíram das tabelas acima porque o arquivo não existe aqui — um
...
|---|---|
| `session-memory-emit.py` — emissor de memória do SessionStart | a mudança de orçamento de memória |
