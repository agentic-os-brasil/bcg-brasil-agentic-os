...
- **Causa:** O hook `first-run-scaffold` depende da variável `CLAUDE_PROJECT_DIR` injetada pelo Claude Code. Se essa variável não estiver disponível, o fallback pode cair no diretório corrente em vez da pasta do projeto.
