...
- [PR #150 documentation follow-up] Clarified the separate labels configured,
  local contract-tested, native-qualified, release-ready and pilot-ready, and
  recorded the current evidence boundary (`as_of: 2026-08-02`, base commit
  `03fe7a0bdcb12bf6fbab693fa8e5fca418b160b3`, no fresh Claude/Codex
  native-session receipt, and no signed or clean-device pilot evidence).
